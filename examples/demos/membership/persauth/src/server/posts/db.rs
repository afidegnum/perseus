...
const POST_COLUMNS: &str = "id, title, slug, summary, content, meta_title, meta_description, meta_keywords, og_image, canonical_url, is_published, published_at, created_at, updated_at";

/// Add a new post to the database
pub async fn add_post(client: &Client, post: &CreatePost) -> Result<Post, ServiceError> {
    let statement = client
        .prepare(&format!(
            "INSERT INTO posts (title, slug, summary, content, meta_title, meta_description, meta_keywords, og_image, canonical_url, is_published, published_at)
        ...
        .prepare(&format!(
            "UPDATE posts
             SET title = $1, slug = $2, summary = $3, content = $4,
                 ...
                 og_image = $8, canonical_url = $9, is_published = $10,
